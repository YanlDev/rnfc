...
export default function EquipoObra({
    ...
    const remover = async (miembro: Miembro) => {
        const ok = await confirm({
            titulo: `¿Remover a ${miembro.name}?`,
            descripcion: 'Dejará de tener acceso a esta obra.',
            confirmar: 'Remover',
            destructivo: true,
        });
    ...
    const cancelar = async (invitacion: InvitacionPendiente) => {
        const ok = await confirm({
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {puedeAdministrar && (
                                                <Button
                                                    ...
                                                    aria-label={`Remover a ${m.name} del equipo`}
                                                >
