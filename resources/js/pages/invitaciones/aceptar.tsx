...
import { Building2, Check, LogIn, Mail, UserPlus } from 'lucide-react';
...
export default function InvitacionAceptar({
    invitacion,
    puedeAceptar,
    token,
}: Props) {
    return (
        <>
            <Head title="Invitación a colaborar" />
                    ...
                    <CardContent className="space-y-4 text-sm">
                        <div className="rounded-md border border-border bg-muted/30 p-3">
                            ...
                            <div className="text-xs text-muted-foreground">
                                {invitacion.obra.codigo}
                                {invitacion.obra.entidad &&
                                    ` · ${invitacion.obra.entidad}`}
                            </div>
                        </div>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="text-xs text-muted-foreground">
                                Rol asignado: <strong>{invitacion.rol}</strong>
                            </div>
                        ...
                        {puedeAceptar && token ? (
                            <>
                                <div className="rounded-md bg-muted/40 p-3 text-xs text-muted-foreground">
                                    ...
                                    Confirma para unirte a la obra.
                                </div>
                                <Button
                                    className="w-full"
                                    onClick={() =>
